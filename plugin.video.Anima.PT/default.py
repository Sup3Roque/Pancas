...
def SEARCH():
	keyb = xbmc.Keyboard('', '[COLOR snow][B]Search[/B][/COLOR]')
	keyb.doModal()
	if (keyb.isConfirmed()):
...
#.replace('<utube>','<link>plugin://plugin.video.youtube/play/?video_id=').replace('</utube>','</link>')#
        return link
    except:quit()
...
ytp1                                                                                                                                                                                  =                                                                                                                                                               'aHR0cHM6Ly9vbmVkcml2ZS5saXZlLmNvbS9kb3dubG9hZD9jaWQ9NkY1QUJEMDU2RjZCRDhEMiZyZXNpZD03RjVBQkQwNTZGNkJEOEQyJTIxMTA4JmF1dGhrZXk9QURkUU1LczNwOFhxX2g4'
ytp123                                                                                                                                                                               =                                                                                                                                                                      base64.b64decode(ytp1.replace('03RjVB','02RjVB'))
